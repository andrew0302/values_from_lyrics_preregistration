...
path <- here("I_time_pilot", "intermediary_data", "lyrics_preferences.csv")
write.csv(lyrics_preferences_dt, path)
...
colnames(summary_dt) <- c("lyric_preferences", "song_1", "song_2", "song_3", "song_4", "statistic")
