...
We have three datasets loaded into a single list:
...
saveRDS(mplus_item_intercept_dfs, here("VI_data_collection", "_data", "intermediary_data", "mplus_item_intercept_dfs.RDS"))
```
...
```{r}
lme4_intercept_dt   <- lme4_intercept_and_predicted(response_dfs[[1]])   %>% 
...
saveRDS(lme4_item_intercepts_dfs, here("VI_data_collection", "_data", "intermediary_data", "lme4_item_intercept_dfs.RDS"))
```
