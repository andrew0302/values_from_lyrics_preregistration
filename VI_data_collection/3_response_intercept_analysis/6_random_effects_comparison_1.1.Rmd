...
lme4_intercept_dfs <- readRDS(here("VI_data_collection", "_data","intermediary_data", "lme4_item_intercept_dfs.RDS"))

# mplus item intercepts
mplus_intercept_dfs <- readRDS(here("VI_data_collection", "_data","intermediary_data", "mplus_item_intercept_dfs.RDS"))
```
...
```{r}
lme4_intercept_df  <- lme4_intercept_dfs[[1]]
mplus_intercept_df <- mplus_intercept_dfs[[1]]
```
